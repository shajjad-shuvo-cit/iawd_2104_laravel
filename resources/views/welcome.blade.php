                        ...
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{ asset('frontend_asset')  }}/assets/images/slider-image/slider-2-1.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container align-self-center">
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{ asset('frontend_asset')  }}/assets/images/slider-image/slider-2-2.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{ asset('frontend_asset')  }}/assets/images/icons/1.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 mb-md-30px mb-lm-30px mt-lm-30px">
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{ asset('frontend_asset')  }}/assets/images/icons/2.png" alt="">
                    </div>
                    <div class="feature-content">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{ asset('frontend_asset')  }}/assets/images/icons/3.png" alt="">
                    </div>
                    <div class="feature-content">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('uploads/product_photo') }}/{{ $product->product_image }}" alt="Product" />
                                        </a>
                                        <span class="badges">
