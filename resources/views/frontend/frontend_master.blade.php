...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend_asset')  }}/assets/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="{{ asset('frontend_asset')  }}/assets/css/plugins/plugins.min.css" />
...
<body>
    ...
    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <script src="{{ asset('frontend_asset')  }}/assets/js/vendor/vendor.min.js"></script>
    <script src="{{ asset('frontend_asset')  }}/assets/js/plugins/plugins.min.js"></script>
