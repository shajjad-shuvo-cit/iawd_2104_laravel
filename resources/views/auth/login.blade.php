              ...
              <form method="POST" action="{{ route('login') }}">
                  @csrf
                    <div class="form-group">
                        <input id="email"  name="email" class="form-control form-control-lg @error('email') is-invalid @enderror"  type="email" placeholder="email" autocomplete="off">
                        @error('email')
                    ...
                    <div class="form-group">
                        <input id="password" name="password" class="form-control form-control-lg @error('password') is-invalid @enderror"  type="password" placeholder="Password">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
